...
/*   Updated: 2021/01/30 20:00:50 by jsimonis      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void material_perfect_mirror(const t_scene* scene, const void* material_data, const t_material_trace_data* trace_data, t_color_hdr* o_hdr)
{
	...
	float dot = vec3_dot(&new_ray.direction, &trace_data->hit->normal);
	t_vec3 temp;
...
{
	t_material_perfect_mirror* perfect_mirror = malloc(sizeof(t_material_perfect_mirror));
